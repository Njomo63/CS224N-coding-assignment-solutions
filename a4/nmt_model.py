...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(embed_size, self.hidden_size, 1, True, True, self.dropout_rate, True)
        self.decoder = nn.LSTMCell(embed_size + hidden_size, self.hidden_size, True)
